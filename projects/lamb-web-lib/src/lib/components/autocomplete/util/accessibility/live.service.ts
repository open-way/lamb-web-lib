...
// /blob/6405da9b8e8532a7e5c854c920ee1815c275d734/src/cdk/a11y/live-announcer/live-announcer.ts#L50
...
export class LiveService implements OnDestroy {
    ...
    constructor(@Inject(DOCUMENT) protected document: any,
        @Inject(ARIA_LIVE_DELAY) protected _delay: ARIA_LIVE_DELAY_TYPE) {
